			...
			<div className="poster-container">
				...
				<div className="content">
					...
					<section className="schedule-section">
						<div className="section-header">
							<h2 className="section-title">Lịch học của bạn</h2>
						</div>

						<div className="simple-sessions-list">
							{/* <!-- Hôm nay --> */}
							<div className="schedule-date-section">
								<div className="schedule-date">
									<i className="material-icons">today</i>
									Hôm nay - Thứ Sáu, 24/10/2025
								</div>

								<div className="enhanced-session-item">
									<div className="session-main-info">
										<div className="session-time-large">14:00 - 16:00</div>
										<div>
											<div className="session-subject-large">Toán cao cấp</div>
											<div className="session-tutor-large">
												<img
													src="https://sfile.chatglm.cn/images-ppt/aa7eaf65d023.jpg"
													alt="Tutor"
													className="session-tutor-avatar-small"
												/>
												Nguyễn Văn An
											</div>
										</div>
									...
									<div className="session-actions">
										<button className="session-button join-btn">Tham gia</button>
										<button className="session-button cancel-btn">Hủy</button>
									</div>
								</div>
							</div>
							...
							<div className="schedule-date-section">
								<div className="schedule-date">
									...
									Ngày mai - Thứ Bảy, 25/10/2025
								</div>

								<div className="enhanced-session-item">
									<div className="session-main-info">
										<div className="session-time-large">10:00 - 12:00</div>
										<div>
											<div className="session-subject-large">Cấu trúc dữ liệu</div>
											<div className="session-tutor-large">
												<img
													src="https://sfile.chatglm.cn/images-ppt/23a3a1c921c8.jpeg"
													alt="Tutor"
													className="session-tutor-avatar-small"
												/>
												Trần Thị Bình
							...
							<div className="schedule-date-section">
								...
								<div className="enhanced-session-item">
									<div className="session-main-info">
										<div className="session-time-large">15:00 - 17:00</div>
										<div>
											<div className="session-subject-large">Trí tuệ nhân tạo</div>
											<div className="session-tutor-large">
												<img
													src="https://sfile.chatglm.cn/images-ppt/a8a24ee0becc.jpg"
													alt="Tutor"
													className="session-tutor-avatar-small"
												/>
												Lê Văn Cường
									...
									<div className="session-actions">
										<button className="session-button join-btn">Đăng ký</button>
									</div>
								</div>
							</div>

							{/* <!-- Thêm các buổi học khác --> */}
							<div className="schedule-date-section">
								<div className="schedule-date">
								...
								<div className="enhanced-session-item">
									<div className="session-main-info">
										<div className="session-time-large">09:00 - 11:00</div>
										<div>
											<div className="session-subject-large">Lập trình cơ bản</div>
											<div className="session-tutor-large">
												<img
													src="https://sfile.chatglm.cn/images-ppt/aa7eaf65d023.jpg"
													alt="Tutor"
